...
import com.testiranje.java.josko.service.HeaderDataService;
...
public class HeaderDataController {
	...
	public HeaderDataController(HeaderDataService headerDataService) {

		this.headerDataService = headerDataService;
	}

	@PostMapping
	public ResponseEntity<String> saveHeaderData(@RequestParam("file") MultipartFile file) {
		...
		try {
			...
			headerDataService.saveHeaderData(recordHeaderList);
